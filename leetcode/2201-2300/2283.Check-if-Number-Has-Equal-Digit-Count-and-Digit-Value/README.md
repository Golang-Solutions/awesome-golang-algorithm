# [2283.Check if Number Has Equal Digit Count and Digit Value][title]
...
[title]: https://leetcode.com/problems/check-if-number-has-equal-digit-count-and-digit-value/
